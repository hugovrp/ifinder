...
class ChatAgent:
    ...
    def __init__(self):
        ...
        print('Tools', [t.name for t in self.available_tools], '\n')
        ...
        self.agno_agent = Agent(
            ...
            instructions = [
                ...
                "Utilize todas as suas tools disponíveis para ser capaz de responder", 
                "Importante: Você está com permissão para: Automatizar navegador real, Simular comportamento humano, Usar Selenium / WebDriver e Acessar páginas dinamicamente com execução de JS",
        ...
        print('\nInstruções', self.agno_agent.instructions, '\n')
